...
TAG_ALIASES: dict[str, list[str]] = {
    ...
    "spa":                     ["relax_wellness"],
    "entertainment":           ["attractions_for_kids"],
    ...
    "outdoor":                 ["nature_landscape"],
    "craft_beer":              ["local_food_experience"],
    "brewery":                 ["local_food_experience"],
    "beer_tasting":            ["local_food_experience"],
    "chocolate_tasting":       ["local_food_experience"],
    "sweet_tasting":           ["local_food_experience"],
    "entertainment":           ["attractions_for_kids"],
